...
//Definição das opções que acenderão conforme cores definidas
// 0 - verde
// 1 - vermelho
// 2 - amarelo
// 3 - azul
...
function incrementColorSequence(_player){
    let generateColor = () => {
        ...
        // The Math.random() function returna a floating-point, pseudo-random number in the range 0 to less 
